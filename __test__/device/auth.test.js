...
beforeAll(async function (){
  try {
    ...
    insertedUser = await user.insertOne({
      username: 'Cletus_Jakubowski96',
      password: 'WPyUM1sVXuAwIMn',
      email: 'Keon.Prohaska@yahoo.com',
      name: 'Matt Koch',
      userType: 319,
      mobileNo: '(840) 362-5847',
      resetPasswordLink: {},
      loginRetryLimit: 950,
      loginReactiveTime: '2023-06-20T20:41:06.672Z',
      id: '62ee4ab81b349b073a1caeef'
    });
  }
  catch (error) {
...
describe('POST /register -> if email and username is given', () => {
  test('should register a user', async () => {
    let registeredUser = await request(app)
      ...
      .send({
        'username':'Isaiah_Will74',
        'password':'OQuUrmO2xpGWggp',
        'email':'Amy26@gmail.com',
        'name':'Ms. Della Bogan',
        'userType':authConstant.USER_TYPES.User,
        'mobileNo':'(732) 407-4030',
