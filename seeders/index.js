...
async function seedUser () {
  try {
    ...
    userToBeInserted = {
      'password':'HdE9gyvywcm2Fu8',
      'isDeleted':false,
      'username':'Hilton_Rowe40',
      'email':'Doyle_Hammes69@gmail.com',
      'isActive':true,
      'userType':authConstant.USER_TYPES.User
    };
    userToBeInserted.password = await bcrypt.hash(userToBeInserted.password, 8);
    let user = await userDb.updateOne( { 'username':'Hilton_Rowe40' }, userToBeInserted,  {
      upsert: true,
      new: true
    });
    userToBeInserted = {
      'password':'8hEAakVLqjvD7q7',
      'isDeleted':false,
      'username':'Kamron52',
    ...
    userToBeInserted.password = await bcrypt.hash(userToBeInserted.password, 8);
    let admin = await userDb.updateOne( { 'username':'Kamron52' }, userToBeInserted,  {
      upsert: true,
      new: true
    });
